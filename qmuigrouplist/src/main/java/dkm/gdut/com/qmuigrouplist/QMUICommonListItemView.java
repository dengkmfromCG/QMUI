package dkm.gdut.com.qmuigrouplist;
...
import dkm.gdut.com.qmuigrouplist.util.QMUIDisplayHelper;
import dkm.gdut.com.qmuigrouplist.util.QMUILangHelper;
import dkm.gdut.com.qmuigrouplist.util.QMUIResHelper;
import dkm.gdut.com.qmuigrouplist.util.QMUIViewHelper;
 ...
 *     也可以在 xml 中使用 {@link dkm.gdut.com.qmuigrouplist.R.styleable#QMUICommonListItemView_qmui_orientation} 设置。</li>
 *     <li>通过 {@link #setAccessoryType(int)} 设置右侧 View 的类型, 可选的类型见 {@link QMUICommonListItemAccessoryType},
 *     也可以在 xml 中使用 {@link dkm.gdut.com.qmuigrouplist.R.styleable#QMUICommonListItemView_qmui_accessory_type} 设置。</li>
 * </ul>
 *
 * @author chantchen
 * @date 2015-1-8

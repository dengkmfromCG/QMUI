package dkm.gdut.com.qmuibottomsheet;
...
import dkm.gdut.com.qmuibottomsheet.util.QMUIDisplayHelper;
import dkm.gdut.com.qmuibottomsheet.util.QMUILangHelper;
import dkm.gdut.com.qmuibottomsheet.util.QMUIResHelper;
...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        private View buildViews() {
            ClosableSlidingLayout wrapperView = (ClosableSlidingLayout) View.inflate(mContext, getContentViewLayoutId(), null);
            mTitleTv = (TextView) wrapperView.findViewById(R.id.title);
            mContainerView = (ListView) wrapperView.findViewById(R.id.listview);

            wrapperView.mTarget=mContainerView;
            if (!cancelOnSwipeDown) wrapperView.swipeable = cancelOnSwipeDown;

            //用于实现滑动小于一半时，反弹。。。但是还未实现
            wrapperView.setSlideListener(new ClosableSlidingLayout.SlideListener() {
                @Override
